...
def process_audio(audio_path):
    ...
    envelope_signal = hilbert.envelope(filtered_signal)
    ...
    plt.subplot(3, 1, 1)
    plt.plot(time, original_signal, color='blue', label="Señal Original")
    plt.title("Señal Original")
    plt.xlabel("Tiempo (s)")
    plt.ylabel("Amplitud")

    plt.subplot(3, 1, 2)
    plt.plot(time, filtered_signal, color='green', label="Señal Filtrada")
    plt.title("Señal Filtrada")
    plt.xlabel("Tiempo (s)")
    plt.ylabel("Amplitud")

    plt.subplot(3, 1, 3)
    plt.plot(time, final_signal, color='red', label="Señal Envolvente")
